...
{/* 
movieContainer =>
    <div class="movie-container row row-cols-1 row-cols-md-3 g-4">
...
const options = {
    ...
    headers: {
        ...
        //   여기 바꾸기
        Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIzZmJhZGNiNDU2ZmM5M2U1ZTg5ZGEyOGNlNWYzOTUyYyIsInN1YiI6IjY2MmU5ODAzOGE4OGIyMDEyYWNlN2NmNCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.SLuEhA6KRHJagR3XoIrP10CIqSQAUMaYdJU6e_mRm1E'
    }
};
...
fetch('https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=1&sort_by=popularity.desc', options)
    ...
    .then(response => {
        ...
        // movieContainer 안에 아래 코드를 넣어준다


        //     const card = `<div class="col">
        //         <div class="card h-100">
        //             <img src="https://image.tmdb.org/t/p/w500/${response.results[0].poster_path}" class="card-img-top" alt="...">
        //             <div class="card-body">
        //                 <h5 class="card-title">${response.results[0].title}</h5>
        //                 <p class="card-text">${response.results[0].overview}</p>
        //             </div>
        //         </div>
        //     </div>
        //     `

        //     const card2 = `<div class="col">
        //     <div class="card h-100">
        //         <img src="https://image.tmdb.org/t/p/w500/${response.results[1].poster_path}" class="card-img-top" alt="...">
        //         <div class="card-body">
        //             <h5 class="card-title">${response.results[1].title}</h5>
        //             <p class="card-text">${response.results[1].overview}</p>
        //         </div>
        //     </div>
        // </div>
        // `
        ...
        // 반복문
        response.results.forEach((데이터) => {
            const card = `<div class="col">
                <div class="card h-100">
                    <img src="https://image.tmdb.org/t/p/w500/${데이터.poster_path}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">${데이터.title}</h5>
                        <p class="card-text">${데이터.overview}</p>
                    </div>
                </div>
            </div>
            `
